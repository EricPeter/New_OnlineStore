			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							<div class="shop-img">
								<img src="./img/george-walker-eKf44HSIH1E-unsplash.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Chicken</h3>
								<a href="store.php" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							<div class="shop-img">
								<img src="./img/Black_White_580x.jpg" alt="">
							</div>
							<div class="shop-body">
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Birds</a></li>
									<li><a data-toggle="tab" href="#tab1">Beads</a></li>
									<li><a data-toggle="tab" href="#tab1">Necklaces</a></li>
									<li><a data-toggle="tab" href="#tab1">Flower Vases</a></li>
								</ul>
							</div>
						</div>
					</div>
