	...
	<div class="container-fluid">
			...
			<div class="col-75">
				...
				<form action="mm_pay.php" method="post">
					...
					<div class="col-50">
						...
						<input type="submit" name="submit"  class="checkout-btn" value="Confrim Payment" >
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="hidden" name="total_price" value="Payment on Delivery">
		...
		?>
			...
			<div class="col-25">
				...
				<h3>total<span class='price' style='color:black'><b>Shs $total</b></span></h3>";
